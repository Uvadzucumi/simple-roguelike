...
class CWorldMap{
    ...
    public:
        ...
        // helper functions for create biome out map
        void BiomeMapFill(TileGame *biome_map, EGameTile tile_type);
        void BiomeMapAdd(TileGame *biome_map, EGameTile tile_type, int item_count);
